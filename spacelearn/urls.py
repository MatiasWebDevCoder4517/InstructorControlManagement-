...
urlpatterns = [
    ...
    path('quiz/<int:quiz_pk>/<int:question_pk>/',
    ...
    path('quiz/<int:pk>/results/',
         views.QuizResultsView.as_view(), name='quiz_results'),
    ...
    path('itutorials/<int:pk>/', views.ITutorialDetail.as_view(),
         name="itutorial-detail"),
    ...
    path('tutorials/<int:pk>/', views.LTutorialDetail.as_view(),
